...
public class MxcController {
    ...
    public String index(Model model) {
        ...
        model.addAttribute("description", "Продажа перемешивающих устройств: " +
                "диссольверы, миксеры, пьяные бочки напрямую от производителя. Высокое качество, " +
                "гарантия и доставка по РФ. Заказывайте у МХС21!");
        return "index";
    }
